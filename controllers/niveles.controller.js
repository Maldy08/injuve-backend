...
exports.createNivel = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: 'Nivel creado exitosamente', id: result.insertedId });
    } catch (error) {
...
exports.updateNivel = async (req, res) => {
    ...
    // Evita inconsistencias al cambiar el identificador en el body.
